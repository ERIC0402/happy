...
<html>
 <head> 
  ...
  <link rel="stylesheet" type="text/css" href="<%=basePath %>static/show/script/swiper.min.css" /> 
  <style type="text/css">
        *, *:before, *:after {
  ...
  <div class="swiper-container swiper-container-horizontal swiper-container-3d swiper-container-coverflow" style="cursor: -webkit-grab;"> 
   <div class="swiper-wrapper">
    ...
    <c:forEach items="${photos }" var="photo">
    	<div class="swiper-slide" style="background-image: url('<%=basePath%>file/download?filePath=${photo.filepath }&fileName=${photo.filename }');"> 
